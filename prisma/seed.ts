...
async function main() {
  ...
  const depotsPDB = [
    ...
    "CLAMART - PARC D'ACTIVITÉS PLESSIS", "COIGNIÈRES - N10",
    "DIJON-MARSANNAY - ZONE ACTI SUE", "GRIGNY - N7", "IVRY-SUR-SEINE - QUAI D'IVRY",
    ...
    "MÉRIGNAC - Z.A.C. PICHEY", "MONTPELLIER - Z.A.C GAROSUD",
    "MONTROUGE - N20 PTE D'ORLÉANS", "MONTROUGE - PTE DE CHÂTILLON",
    "NANTERRE - A86", "NANTES - REZÉ - ROUTE DE PORNIC",
    "NEUILLY-SUR-SEINE - PONT DE NEUILLY", "NEUILLY-SUR-SEINE - PORTE MAILLOT",
    "NICE - L'ARIANE", "NICE - MAGNAN", "ORLÉANS - FLEURY-LES-AUBRAIS",
    "PANTIN - HALLE DE PANTIN", "PARIS 03 - TURBIGO - ST-MARTIN",
    "PARIS 11 - BD. JULES FERRY", "PARIS 12 - AV. DU GÉNÉRAL BIZOT",
    ...
    "PUTEAUX - ROND POINT DES BERGÈRES", "ROUBAIX - QUAI DE GAND",
    "ROUEN - SOTTEVILLE-LÈS-ROUEN", "SAINT-BRICE - N1", "SAINT-DENIS - A86",
    "SAINT-GERMAIN-EN-LAYE", "TOULON - Z.I TOULON EST", "TOULOUSE - LES MINIMES",
    "TOULOUSE - Z.I. DE GRAMONT", "TOULOUSE - Z.I. DU CHAPÎTRE",
    "VAULX-EN-VELIN - Z.I. - LYON", "VÉNISSIEUX - AV. PRESSENSÉ",
