...
export type DocCheck = { id?: string; nom: string; recu: boolean; date: string | null; type?: string; qualificationAssociee?: string | null; fichierUrl?: string | null; fichierNom?: string | null };
