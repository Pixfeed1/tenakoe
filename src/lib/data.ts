...
export type PipelineItem = { id: string; nom: string; chargee: string; chargeeId?: string | null; prescripteur: string; date: string; siret: string; etatAvancement?: string | null; etatAvancementCouleur?: string | null };
